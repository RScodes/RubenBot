...
IF EXIST %SYSTEMROOT%\bot-first.exe (
    CMD /k bot-first.exe -3.5 bot-first.js
    EXIT
)
...
CMD /k javascript bot-first.js
GOTO end

:nojavascript
ECHO ERROR: javascript has either not been installed or not added to your PATH.
